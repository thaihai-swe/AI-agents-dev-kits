...
This prompt is a compatibility alias for the implementation review step and should use the `spec-review` agent.
...
Follow the contract in `.github/agents/spec-review.agent.md`.

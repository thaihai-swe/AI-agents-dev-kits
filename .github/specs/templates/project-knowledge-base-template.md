...
Describe what stable repository knowledge this file stores and how agents should use it alongside `memories/constitution.md`.
...
- If a fact here conflicts with `memories/constitution.md`, treat the constitution as authoritative.
...
- What should instead go to `memories/constitution.md`:
